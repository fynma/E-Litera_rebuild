                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="d-none d-lg-inline text-gray-600 small">Sabilla Andhini (Petugas)</span>
                            </a>
            ...
            function updateTable(data) {
                ...
                $.each(data, function(index, user) {
                    var row = '<tr>' +
                        ...
                        '<button class="btn-delete" data-id="' + user.user_id + '"><i class="bi bi-trash"></i></button>' +
                        '</td>' +
                        '</tr>';
        ...
        function deleteUser(userId) {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    fetchData(); // Assuming fetchData() fetches and updates the table
                },
                error: function(xhr, status, error) {
